...
our($emacs_Time_stamp) = 'Time-stamp: <2013-12-30 16:02:42 johayek>' =~ m/<(.*)>/;

##our     $rcs_Id=(join(' ',((split(/\s/,'$Id: procmail-from2diary.pl 1.44 2013/12/30 15:01:02 johayek Exp $'))[1..6])));
##our   $rcs_Date=(join(' ',((split(/\s/,'$Date: 2013/12/30 15:01:02 $'))[1..2])));
...
# $Id: procmail-from2diary.pl 1.44 2013/12/30 15:01:02 johayek Exp $
